...
#ifndef YY_YY_AUL_TAB_HH_INCLUDED
# define YY_YY_AUL_TAB_HH_INCLUDED
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // visibility
      // scope
      char dummy2[sizeof (astNodeFlags)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, astNodeFlags&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const astNodeFlags& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, typeNode*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const typeNode*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      case 49: // program
      case 50: // moduleDeclaration
      case 51: // packageDefinition
      case 52: // definitions
      case 53: // definition
      case 54: // statements
      case 55: // statement
      case 56: // localVariableDefinition
      case 57: // variableDefinition
      case 58: // functionDefinition
      case 59: // argumentList
      case 60: // argument
      case 61: // returnStatement
      case 62: // expression
      ...
      case 63: // visibility
      case 64: // scope
        value.template destroy< astNodeFlags > ();
        break;

      case 3: // IDENTIFIER
      case 47: // dottedIdentifier
      ...
      case 48: // type
        value.template destroy< typeNode* > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::END || tok == token::LEFT_PAREN || tok == token::RIGHT_PAREN || tok == token::LEFT_BRACKET || tok == token::RIGHT_BRACKET || tok == token::LEFT_BRACE || tok == token::RIGHT_BRACE || tok == token::EQUALS || tok == token::COMMA || tok == token::DOT || tok == token::SEMICOLON || tok == token::LESS_THAN || tok == token::GREATER_THAN || tok == token::PLUS || tok == token::MINUS || tok == token::MULTIPLY || tok == token::DIVIDE || tok == token::MODULE || tok == token::PACKAGE || tok == token::EXPORT || tok == token::INTERNAL || tok == token::INSTANCE || tok == token::STATIC || tok == token::RETURN || tok == token::BOOLEAN || tok == token::CHAR || tok == token::I8 || tok == token::I16 || tok == token::I32 || tok == token::I64 || tok == token::ISIZE || tok == token::U8 || tok == token::U16 || tok == token::U32 || tok == token::U64 || tok == token::USIZE || tok == token::F32 || tok == token::F64 || tok == token::PTR || tok == token::TRUE || tok == token::FALSE);
      }
#else
      ...
      symbol_type (int tok, double v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YY_ASSERT (tok == token::INTEGER || tok == token::DECIMAL);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_INTEGER (double v, location_type l)
      {
      ...
      static
      symbol_type
      make_INTEGER (const double& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_INTERNAL (location_type l)
      {
        return symbol_type (token::INTERNAL, std::move (l));
      }
#else
      static
      symbol_type
      make_INTERNAL (const location_type& l)
      {
        return symbol_type (token::INTERNAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ISIZE (location_type l)
      {
        return symbol_type (token::ISIZE, std::move (l));
      }
#else
      static
      symbol_type
      make_ISIZE (const location_type& l)
      {
        return symbol_type (token::ISIZE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::USIZE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::USIZE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 63: // visibility
      case 64: // scope
        value.move< astNodeFlags > (std::move (that.value));
        break;
      ...
      case 48: // type
        value.move< typeNode* > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 63: // visibility
      case 64: // scope
        value.copy< astNodeFlags > (YY_MOVE (that.value));
        break;
      ...
      case 48: // type
        value.copy< typeNode* > (YY_MOVE (that.value));
        break;
   ...
   Parser ::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 63: // visibility
      case 64: // scope
        value.move< astNodeFlags > (YY_MOVE (s.value));
        break;
      ...
      case 48: // type
        value.move< typeNode* > (YY_MOVE (s.value));
        break;
...
#endif // !YY_YY_AUL_TAB_HH_INCLUDED
