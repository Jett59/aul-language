...
%type <std::unique_ptr<aul::AstNode>> definition expression integer-expression cast-expression function-expression binary-expression unary-expression variable-reference statement block-statement
%type <std::unique_ptr<aul::DefinitionsNode>> definitions
%type <std::unique_ptr<aul::Type>> type type-no-intersection array-type tuple-type function-type type-intersection type-alias
...
expression: integer-expression | cast-expression | function-expression | binary-expression | unary-expression | variable-reference
| "(" expression ")" {
    $$ = $2;
    }
